...
import com.eryan.calendarviewsample.databinding.HomeOptionsItemViewBinding
...
class HomeOptionsAdapter(val onClick: (ExampleItem) -> Unit) :
    ...
    val examples = listOf(
        ExampleItem(R.string.example_1_title, R.string.example_1_subtitle) { CalendarFragment() },
        )
