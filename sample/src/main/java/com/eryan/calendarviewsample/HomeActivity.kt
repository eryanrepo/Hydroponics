...
import com.eryan.calendarviewsample.databinding.HomeActivityBinding
...
class HomeActivity : AppCompatActivity() {
    ...
    private val examplesAdapter = HomeOptionsAdapter {
        ...
        supportFragmentManager.beginTransaction()
            .run {
                if (fragment is CalendarFragment || fragment is CalendarFragment || fragment is CalendarFragment) {
